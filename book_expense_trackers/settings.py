"""
Django settings for book_expense_trackers project.
...
SECRET_KEY = 'django-insecure-e73r6qshsa@opapu9evcgxix#u99!9h(#s4pr=fczacvne_xxh'
...
WSGI_APPLICATION = 'book_expense_trackers.wsgi.application'
